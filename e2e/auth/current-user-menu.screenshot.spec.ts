...
const mockUser = {
  ...
  login: 'mockCurrentUserMenuScreenshotLogin',
  email: 'mock-current-user-menu-screenshot@email.email',
  password: 'mockPasswo@123rd',
  phone: '79999999999',
};

test('current user menu @visual', async ({ page, request }) => {
  ...
  await expect(page).toHaveScreenshot('current-user-menu.png', { maxDiffPixels: 2000 });
});
