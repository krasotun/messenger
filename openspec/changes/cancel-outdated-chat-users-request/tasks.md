...
- [ ] 1.3 Проверить, что `src/app/domains/chats/application/add-chat-user/add-chat-user.service.spec.ts` и `src/app/domains/chats/presentation/selected-chat-header/selected-chat-header.spec.ts` зеленые без правок
- [ ] 1.4 Прогнать `npm run lint` и `npm run test:ci`
