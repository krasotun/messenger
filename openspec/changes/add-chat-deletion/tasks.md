...
- [ ] 6.3 Обновить артборды `HeaderDeleteVisibility` и `DeleteChat` в канвасе экрана чатов: убрать состояния «запрос идет» и «ошибка в окне», показать закрытие окна сразу после ответа и исход **Уведомлением**
